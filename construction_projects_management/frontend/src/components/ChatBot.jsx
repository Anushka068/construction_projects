...
export default function ChatBot() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {open && (
        <div className="w-96 h-[500px] rounded-2xl shadow-2xl bg-white dark:bg-gray-900 flex flex-col border border-gray-200 dark:border-gray-700 mb-4">
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700">
            <div className="flex gap-2">
              <input
                className="flex-1 border border-gray-300 dark:border-gray-600 p-3 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
